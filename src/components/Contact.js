            ...
            <Col size={12} md={6}>
              <TrackVisibility>
                ...
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  <h2 className="mb-1">Request for quot</h2>
                  <Nav.Link href="https://forms.gle/MYmA61eVZrrUFLuq9"><h5 className="mb-3">Or response the form <UiChecks /></h5></Nav.Link>
                  <form onSubmit={sendEmail}>
                    ...
                    <Row>
                      ...
                      <Col size={12} sm={6} className="px-1">
                        <input type="text" name="full_name" value={formDetails.fullName} placeholder="Name" onChange={(e) => onFormUpdate("fullName", e.target.value)} />
                      </Col>
                      <Col size={12} sm={6} className="px-1">
                      ...
                      <Col size={12} sm={12} className="px-1">
                        <input type="text" name="title" value={formDetails.title} placeholder="Title*" onChange={(e) => onFormUpdate("title", e.target.value)} required={true} autoComplete="title" />
                      </Col>
                      <Col size={12} className="px-1">
                        <textarea rows="6" name="message" value={formDetails.message} placeholder="Enter the description for your request.*" onChange={(e) => onFormUpdate("message", e.target.value)} required={true}></textarea>
